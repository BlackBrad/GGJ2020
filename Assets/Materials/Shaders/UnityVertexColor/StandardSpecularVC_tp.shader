...
Shader "Standard Specular Triplanar (Vertex Color)"
{
    Properties
    {
		[PerRendererData]_InstancedColorTint("_InstancedColorTint", Color) = (1,1,1,1)
		_Color("Color", Color) = (1,1,1,1)
        _MainTex("Albedo", 2D) = "white" {}

		_BlendColor("BlendColor", Color) = (1,1,1,1)
		_BlendTexToColor2("BlendTexToColor2", 2D) = "black" {}
        ...
        _IntensityVC("Vertex Color Intensity", Float) = 1.0
		 ...
		 [ToggleOff] _HolesEnabled("Holes", Float) = 0

		 [ToggleOff] _UseInstancedColorTints("UseInstancedColorTints", Float) = 0
    }

    CGINCLUDE
        #define UNITY_SETUP_BRDF_INPUT SpecularSetup

		#define VERTEX_SHADER_TRIPLANAR 1

		#define BLEND_COLORS 1
		//#define INSTANCED_COLOR_TINTS 1
    ENDCG
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			#pragma shader_feature _HOLES
			#pragma shader_feature INSTANCED_COLOR_TINTS
